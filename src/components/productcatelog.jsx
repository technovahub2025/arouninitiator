    ...
    <section className="product-section animate-reveal-up" id="products">
      <div className="product-container">
        ...
        <div className="product-grid">
          <div className="large-product-card animate-pop-in">
            <div className="product-content">
              ...
              <button type="button" onClick={() => scrollToSection("bulk")}>View More</button>
            </div>
          ...
          <div className="small-products-grid">
            <div className="small-product-card animate-pop-in delay-1">
              <div className="product-icon blue-icon"><FaHeadSideMask /></div>
              <h4>Face Masks</h4>
              <p>Medical Grade</p>
            </div>

            <div className="small-product-card animate-pop-in delay-2">
              <div className="product-icon red-icon"><FaUserShield /></div>
              <h4>PPE Kits</h4>
              <p>Full Protection</p>
            </div>

            <div className="small-product-card animate-pop-in delay-3">
              <div className="product-icon dark-icon"><FaUserMd /></div>
              <h4>Surgical Gowns</h4>
              <p>Sterile Wear</p>
            </div>

            <div className="small-product-card animate-pop-in delay-4">
